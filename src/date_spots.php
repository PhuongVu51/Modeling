...
<head>
    ...
    <title>Date Spots in Hanoi – SoulSync</title>
    <meta name="description" content="Discover the perfect date spots in Hanoi curated for SoulSync couples.">
...
<div class="datespots-page">
    ...
    <!-- ── HEADER ── -->
    <div class="ds-header">
        <h1 class="ds-title">Date Spots in Hanoi</h1>
    ...
    <div class="ds-recommendation">
        ...
        <div class="rec-venues">
            <a href="date_spot_detail.php?id=3" class="rec-venue-card">
                ...
                <div class="rec-venue-info">
                    ...
                    <p class="rec-venue-meta">
                        ...
                        <span class="rec-venue-sync">❤️ 93% Match</span>
                    </p>
                </div>
            </a>
            <a href="date_spot_detail.php?id=1" class="rec-venue-card">
                ...
                <div class="rec-venue-info">
                    <p class="rec-venue-name">Serein Cafe</p>
                    <p class="rec-venue-meta">
                        Heritage Vibe • Long Bien<br>
                        <span class="rec-venue-sync">❤️ 90% Match</span>
                    </p>
                </div>
            </a>
        </div>
...
<div class="modal-overlay" id="suggest-modal" onclick="closeModalOnOverlay(event)">
    <div class="suggest-modal">
        ...
        <h3 class="modal-title">Suggest a Date Spot?</h3>
        <p class="modal-desc">Send <span class="modal-venue-name" id="modal-venue-name">this venue</span> to your match as a date idea. They'll receive a sweet notification!</p>
